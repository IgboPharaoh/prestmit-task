          ...
          <section className={`${styles.featureTopSection} ${styles.featureTopSection2}`}>
            <div className={styles.featureTopRigtSection}>
              ...
              <section className={`${styles.featureListsWrapper} ${styles.featuresCardsListWrapper}`}>
                <FeaturesCard text='We connect our customers with the best.' color='#ffffff' src={<FeatherIcon />} backgroundColor='#0A2640' />
                <FeaturesCard text='Advisor success customer launch party.' color='#000000' src={<EyeIcon />} backgroundColor='#ffffff' />
